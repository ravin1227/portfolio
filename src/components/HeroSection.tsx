    ...
    <main className="relative flex flex-col items-center justify-center">
      <section id="hero-section" className="relative mb-10 min-h-screen w-full overflow-hidden">
          ...
          <h1 className="animate-fadeInUp grad-white relative z-20 mt-4 mb-7 flex flex-col items-center justify-center text-center text-xl sm:flex-row md:text-xl lg:mt-7 lg:text-2xl">
            <span className="grad-white flex items-center justify-center">
              ...
              >
                ...
                {showWand && (
                  <div 
                    className="pointer-events-none absolute top-0 left-0 z-50 flex items-center justify-center rounded-full border border-white/[0.25] backdrop-blur-sm"
                    style={{
        ...
        <div className="relative h-60 w-full z-[19] mt-8">
          <div 
            className="absolute bottom-0 right-[10%] z-0 h-[400px] w-[1200px] transform overflow-hidden"
            style={{
          ...
          >
            ...
            <div className="absolute bottom-[167px] left-1/2 h-[111px] w-[787px] -translate-x-1/2 transform overflow-hidden bg-[radial-gradient(50%_50%_at_50%_50%,#5506ba_0%,rgba(10,10,10,0)_100%)] blur-[57px] dark:bg-[radial-gradient(50%_50%_at_50%_50%,#8b5cf6_0%,rgba(255,255,255,0)_100%)]"></div>
            
            {/* Large circular gradient element - original positioning */}
            <div className="absolute right-[-432px] bottom-[-753px] left-[-454px] h-[955px] rounded-[100%] bg-gradient-to-b from-black to-transparent dark:from-white dark:to-transparent"></div>
            
            {/* Main curved element with shadow - original positioning */}
            <div className="absolute right-[-510px] bottom-[-759px] left-[-532px] aspect-[2.346820809248555/1] h-[956px] rounded-[100%] bg-white-1 shadow-[inset_0_2px_20px_#fff,0_-10px_50px_1px_#ffffff7d] dark:!bg-black dark:!shadow-[inset_0_2px_20px_#000,0_-10px_50px_1px_#0000007d] transition-colors duration-300"></div>
          </div>
        </div>
      </section>
    </main>
