      ...
      <div className="grid grid-cols-6 gap-4 md:max-w-full md:auto-rows-[19rem] mb-20 md:my-20">
        ...
        <div className="group relative flex size-full flex-col justify-between overflow-hidden rounded-xl shadow-[0_0_0_1px_rgba(0,0,0,.03),0_2px_4px_rgba(0,0,0,.05),0_12px_24px_rgba(0,0,0,.05)] transform-gpu dark:shadow-[0_-20px_80px_-20px_#ffffff1f_inset] dark:border-[1px_solid_rgba(255,255,255,.1)] border border-white/20 col-span-6 md:col-span-3 lg:col-span-2 md:row-span-2 max-md:h-[32rem]">
          <div className="size-full p-6 flex flex-col justify-between">
            {/* Title */}
            <h3 className="w-full text-center text-2xl font-bold text-gray-300 mb-8">
              I'm very flexible with <span className="text-cyan-400">time zone communications</span>
            </h3>
            
            {/* Country Flags */}
            <div className="flex justify-center gap-2 mb-8">
              <button className="flex items-center gap-1.5 px-3 py-1.5 rounded-full bg-gray-800/50 text-white hover:bg-gray-700/50 transition-colors">
                <span className="text-sm">🇬🇧</span>
                <span className="text-xs font-medium">UK</span>
              </button>
              <button className="flex items-center gap-1.5 px-3 py-1.5 rounded-full bg-cyan-500/20 text-cyan-400 border border-cyan-500/40">
                <span className="text-sm">🇮🇳</span>
            ...
            <div className="relative flex items-center justify-center mb-8 flex-1">
              <div className="relative w-56 h-56">
                <div className="w-full h-full rounded-full bg-gradient-to-br from-slate-800 via-slate-900 to-black border border-cyan-400/20 shadow-2xl flex items-center justify-center">
          ...
          <div className="[mask-image:linear-gradient(to_top,transparent_10%,#000_100%)] absolute inset-0"></div>
        </div>
